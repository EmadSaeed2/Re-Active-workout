...
const exFormPageStyles = {
  ...
  exForm: {
    ...
    padding: "10px",
    border: "2px solid var(--react--yellow)",
...
function ExerciseFormPage(props) {
  ...
  return (
    <>
      ...
      <div
        className="exFormPageContainer"
        style={exFormPageStyles.exFormPageContainer}
      >
        <div
          className="exFormPageCardContainer"
          style={exFormPageStyles.exFormPageCardContainer}
        >
          <FormPageCard userSelection={exerciseData} />
        </div>
        <div
          className="exFormPageCardContainer"
          style={exFormPageStyles.exFormPageCardContainer}
        >
          <form
            ...
            className="exForm"
            style={exFormPageStyles.exForm}
          >
            <h1 style={exFormPageStyles.exForH1}>Plan Your Workout</h1>

            {/* date */}
            <input
              style={exFormPageStyles.exFormInput}
              id="ex-date"
              type={dateInputType}
              placeholder="Date"
              onFocus={() => {
            ...
            <input
              ...
              onChange={(e) => {
                setSelectedRepRange(e.target.value);
              }}
            />
            ...
            <input
              ...
              id="ex-no-of-sets"
              type="number"
              value={selectedNoOfSets}
              onChange={(e) => {
                setSelectedNoOfSets(e.target.value);
              }}
            />
            ...
            <button
              ...
              style={exFormPageStyles.exFormButton}
              type="submit"
            >
              Save To Calendar
            </button>
