        ...
        <div className="cardWrapper" style={formPageCardStyles.cardWrapper}>
            ...
            <div style={formPageCardStyles.textWrapper}>
                ...
                <ul style={formPageCardStyles.listWrapper}>
                    <li style={formPageCardStyles.list}><strong> Muscle:</strong> {props.userSelection.title.muscle.toUpperCase()}</li>
                    <li style={formPageCardStyles.list}><strong> Equipment:</strong> {props.userSelection.title.equipment.toUpperCase()}</li>
                    <li style={formPageCardStyles.list}><strong> Difficulty:</strong> {props.userSelection.title.difficulty.toUpperCase()}</li>
                </ul>
            </div>
        </div>
    )
